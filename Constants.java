...
public class Constants {
    ...
    public static final int autoDistance = 4500;

    // Lift Variables
    public static final double liftUpSpeed = 0.50;
    public static final double liftDownSpeed = 0.50;
    ...
    public static final double clawSpeed = 5.0/12.0;
    ...
    public static final double clawRotateSpeedUp = 1.0;
